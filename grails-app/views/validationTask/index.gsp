    ...
    <article>
        <table class="table table-striped border-collapse">
            ...
            <tr>
                ...
                <th class="right-border"><g:message code="validationTask.numValidationPasses" default="Number of Validation Passes"/></th>
            ...
            <g:each var="validationTask" in="${validationTaskList}">
                <tr>
                    ...
                    <td class="right-border">${validationTask.validationPasses.size()}</td>
